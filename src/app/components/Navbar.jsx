...
import { Link as LinkLocal } from "../../navigation";
  ...
  return (
    <Navbar>
      ...
      <NavbarContent>
        ...
        <NavbarItem className="hidden lg:flex">
          <Link href="https://nextui.org/docs/components/avatar">
            <svg
              fill="none"
              height="24"
              viewBox="0 0 24 24"
        ...
        <NavbarItem>
          {pathname.slice(1) === "vi" ? (
            <LinkLocal locale="en" href="/">
              <Button>{pathname.slice(1) === "vi" ? "en" : "vi"}</Button>
            </LinkLocal>
          ) : (
            <LinkLocal locale="vi" href="/">
              <Button>{pathname.slice(1) === "vi" ? "en" : "vi"}</Button>
            </LinkLocal>
          )}
        </NavbarItem>
